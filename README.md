...
Light/dark and starfield preferences are stored in the browser. The main site defaults to stars unless a visitor has saved an appearance preference. Path of the Jedi is always displayed on the starfield and hides the appearance switches; visiting it does not change the saved preference for other pages. Food retains its separate visual design. Review search, sorting and tags enhance an already-rendered list; all reviews remain accessible without JavaScript.
